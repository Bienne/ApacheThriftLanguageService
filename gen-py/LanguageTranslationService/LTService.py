...
class Client(Iface):
  ...
  def Translate(self, word):
    ...
    Parameters:
     - word
    """
    self.send_Translate(word)
    return self.recv_Translate()

  def send_Translate(self, word):
...
class Processor(Iface, TProcessor):
  ...
  def process_Translate(self, seqid, iprot, oprot):
    ...
    result = Translate_result()
    try:
      result.success = self._handler.Translate(args.word)
    except InvalidValueException as e:
      result.e = e
    oprot.writeMessageBegin("Translate", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class Translate_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (TranslatePackage, TranslatePackage.thrift_spec), None, ), # 0
